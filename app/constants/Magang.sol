...
contract Magang {
    ...
    function registerFor(
        ...
        require(is_admin[msg.sender], "Caller is not authorized to register others");

        require(!is_registered[_user], "User is already registered");
        ...
        is_registered[_user] = true;
        name[_user] = _name;
        role[_user] = _role;
        users.push(ProfileStruct(_user, true, _role, _name));

        emit registerAction(_user, _role, _name, block.timestamp);
